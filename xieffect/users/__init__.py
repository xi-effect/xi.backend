...
from .feedback_rst import controller as feedback_namespace, generate_code, dumps_feedback
from .invites_rst import controller as invites_namespace
...
from .users_mub import controller as users_mub_namespace
