...
"""Default success response representation ({"a": :class:`bool`})"""  # noqa: WPS428, WPS322, E501
message_response: ResponseDoc = ResponseDoc(
    model=Model("Message Response", {"a": StringField})
)  # noqa: WPS462
"""Default message response representation ({"a": :class:`str`})"""  # noqa: WPS322, WPS428, E501
